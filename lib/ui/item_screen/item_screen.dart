...
class ItemScreen extends StatelessWidget {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: List.generate(
                      4,
                      (index) => index == context.watch<ItemProvider>().index
                          ? Container(
                              height: 16.h,
                              width: 16.w,
  ...
  _onTap(BuildContext context) {
    print(Provider.of<BasketProvider>(context,listen: false).listProductLength);
    context.read<BasketProvider>().addProduct(
          Product(
            image: AppImages.imgIpad,
            title: '2020 Apple iPad Air 10.9"',
            price: 579.00, index: Provider.of<BasketProvider>(context,listen: false).listProductLength,
          ),
        );
